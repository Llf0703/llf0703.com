        ...
        <div id="huxblog_navbar">
            <div class="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li> <a href="https://pro.llf0703.com/" target="_blank">项目</a> </li>
                    <li> <a href="https://2018.llf0703.com/" target="_blank">2018</a> </li>
                    <li> <a href="https://www.jxoj.net/" target="_blank">JXOJ</a> </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li> <a id="nav-index" href="<?php $this->options->siteUrl(); ?>">首页</a> </li>
                    <li> <a id="nav-p" href="<?php $this->options->siteUrl(); ?>p/">文章</a> </li>
